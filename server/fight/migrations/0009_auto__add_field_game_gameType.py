...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.gameType'
        db.add_column('fight_game', 'gameType',
                      self.gf('django.db.models.fields.CharField')(default='skirmish', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.gameType'
        db.delete_column('fight_game', 'gameType')
