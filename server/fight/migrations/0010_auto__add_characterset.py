...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CharacterSet'
        db.create_table('fight_characterset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='New Set', max_length=128)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('fight', ['CharacterSet'])

        # Adding M2M table for field chars on 'CharacterSet'
        db.create_table('fight_characterset_chars', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('characterset', models.ForeignKey(orm['fight.characterset'], null=False)),
            ('character', models.ForeignKey(orm['fight.character'], null=False))
        ))
        db.create_unique('fight_characterset_chars', ['characterset_id', 'character_id'])


    def backwards(self, orm):
        # Deleting model 'CharacterSet'
        db.delete_table('fight_characterset')

        # Removing M2M table for field chars on 'CharacterSet'
        db.delete_table('fight_characterset_chars')
