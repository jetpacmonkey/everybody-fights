...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attribute.desc'
        db.alter_column('fight_attribute', 'desc', self.gf('django.db.models.fields.TextField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Attribute.desc'
        db.alter_column('fight_attribute', 'desc', self.gf('django.db.models.fields.CharField')(max_length=256))
