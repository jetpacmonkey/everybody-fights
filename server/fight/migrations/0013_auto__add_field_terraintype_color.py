...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TerrainType.color'
        db.add_column('fight_terraintype', 'color',
                      self.gf('django.db.models.fields.CharField')(default='#FFFFFF', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TerrainType.color'
        db.delete_column('fight_terraintype', 'color')
