...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cell.terrain'
        db.alter_column('fight_cell', 'terrain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fight.TerrainType'], null=True))

    def backwards(self, orm):

        # Changing field 'Cell.terrain'
        db.alter_column('fight_cell', 'terrain_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fight.TerrainType']))
