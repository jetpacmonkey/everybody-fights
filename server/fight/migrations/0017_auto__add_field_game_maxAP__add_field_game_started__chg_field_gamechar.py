...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.maxAP'
        db.add_column('fight_game', 'maxAP',
                      self.gf('django.db.models.fields.IntegerField')(default=20),
                      keep_default=False)

        # Adding field 'Game.started'
        db.add_column('fight_game', 'started',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'GameCharacter.cell'
        db.alter_column('fight_gamecharacter', 'cell_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['fight.GameCell'], unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Game.maxAP'
        db.delete_column('fight_game', 'maxAP')

        # Deleting field 'Game.started'
        db.delete_column('fight_game', 'started')


        # Changing field 'GameCharacter.cell'
        db.alter_column('fight_gamecharacter', 'cell_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['fight.GameCell'], unique=True))
