...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.gamePhase'
        db.add_column('fight_game', 'gamePhase',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Game.turnNum'
        db.add_column('fight_game', 'turnNum',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Game.gamePhase'
        db.delete_column('fight_game', 'gamePhase')

        # Deleting field 'Game.turnNum'
        db.delete_column('fight_game', 'turnNum')
