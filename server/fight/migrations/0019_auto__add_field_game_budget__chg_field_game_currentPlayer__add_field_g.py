...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.budget'
        db.add_column('fight_game', 'budget',
                      self.gf('django.db.models.fields.IntegerField')(default=50),
                      keep_default=False)


        # Changing field 'Game.currentPlayer'
        db.alter_column('fight_game', 'currentPlayer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Adding field 'GamePlayer.apRemaining'
        db.add_column('fight_gameplayer', 'apRemaining',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.budget'
        db.delete_column('fight_game', 'budget')


        # Changing field 'Game.currentPlayer'
        db.alter_column('fight_game', 'currentPlayer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
        # Deleting field 'GamePlayer.apRemaining'
        db.delete_column('fight_gameplayer', 'apRemaining')
    ...
    models = {
        ...
        'fight.gamecharacter': {
            ...
            'cell': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['fight.GameCell']", 'unique': 'True', 'null': 'True'}),
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fight.Character']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
