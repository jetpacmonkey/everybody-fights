...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TerrainModifier'
        db.create_table('fight_terrainmodifier', (
        ...
        db.send_create_signal('fight', ['TerrainModifier'])

        # Adding model 'TerrainRequirement'
        db.create_table('fight_terrainrequirement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('terrain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fight.TerrainType'])),
            ('attribute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fight.Attribute'])),
        ...
        db.send_create_signal('fight', ['TerrainRequirement'])


    def backwards(self, orm):
        # Deleting model 'TerrainModifier'
        db.delete_table('fight_terrainmodifier')

        # Deleting model 'TerrainRequirement'
        db.delete_table('fight_terrainrequirement')
