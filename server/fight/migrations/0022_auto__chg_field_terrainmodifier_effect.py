...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TerrainModifier.effect'
        db.alter_column('fight_terrainmodifier', 'effect', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'TerrainModifier.effect'
        db.alter_column('fight_terrainmodifier', 'effect', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'fight.terrainmodifier': {
            ...
            'attribute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fight.Attribute']"}),
            'effect': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '5', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
